          ...
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(article.urlToImage ?? noImageUrl),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
            ...
            Row(
              children: [
                ...
                Spacer(),
                Status(icon: Icons.remove_red_eye, total: "total 2"),
                SizedBox(width: 15.0),
                Status(icon: Icons.favorite_border, total: "favorite"),
              ],
            ),
            SizedBox(height: 12.0),
            ...
            Row(
              children: [
                Text(article.publishedAt, style: kDetailContent),
                SizedBox(width: 5.0),
                SizedBox(
                  width: 10.0,
                  child: Divider(
